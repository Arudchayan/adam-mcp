...
Close baseline gaps in order when possible: B6–B12 done; A1/A2/A6 done (PR #8 / `e52d947`); A3/A4 done (PR #9 / `a5e1fd6`). A5 deferred Phase B P1; Phase A-thin AT1/AT2 next.
