...
- **Merged:** PR1 docs, PR2 **B6**, PR #5 **B10** (`8af49c0`), PR #6 **B4** (`5982bdd`), PR #7 **B11/B12** (`21728f3`), PR #8 **A1/A2/A6** (`e52d947`), PR #9 **A3/A4** (`a5e1fd6`).
- **In flight:** **Phase A-thin AT1/AT2** (cross-course deadlines via `adam_list_calendar`). **Next:** remaining A-thin; A5 deferred.
...
Status 2026-09-06: through PR #9 A3/A4 (`a5e1fd6`) merged; Phase A-thin AT1/AT2 in flight. A5 deferred. Read AGENTS.md + docs/qa/ before acting.
```
