...
- **Merged:** PR1 docs, PR2 **B6**, PR #5 **B10** (`8af49c0`), PR #6 **B4** (`5982bdd`), PR #7 **B11/B12** (`21728f3`), PR #8 **A1/A2/A6** (`e52d947`).
- **In flight:** **A3/A4** (this PR — confirm≠elicitation docs + SDK pin). **Next:** Phase A-thin; A5 deferred.
...
Status 2026-09-06: through PR #8 A1/A2/A6 (`e52d947`) merged; A3/A4 in flight. Next: Phase A-thin; A5 deferred. Read AGENTS.md + docs/qa/ before acting.
```
