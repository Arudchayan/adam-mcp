...
| [open-pass-criteria.md](open-pass-criteria.md) | Short notes for gates (A1/A2/A6 closed PR #8 / `e52d947`; A3/A4 closed PR #9 / `a5e1fd6`; AT1/AT2 closed PR #10 / `533d5c5`; AT3 closed PR #11 / `01069ef`; A5 deferred; AT4 this PR) |
...
B6–B12 done → A1/A2/A6 done (PR #8 / `e52d947`) → A3/A4 done (PR #9 / `a5e1fd6`) → AT1/AT2 done (PR #10 / `533d5c5`) → AT3 done (PR #11 / `01069ef`) → **Phase A-thin AT4 (this PR)**. A5 deferred Phase B P1.
