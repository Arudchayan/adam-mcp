...
| [open-pass-criteria.md](open-pass-criteria.md) | Short notes for gates still open (baseline closed PR #7; A1/A2/A6 this PR) |
...
B6 (done) → B10 (done, PR #5) → B4 (done, PR #6 / `5982bdd`) → B11/B12 (done, PR #7 / `21728f3`) → **A1/A2/A6 (this PR)** → A3/A4.
