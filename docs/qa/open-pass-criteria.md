...
| A3 | Docs: `confirm:true` = interim schema gate after student asked to read; real confirms/future writes → MCP elicitation when host supports MRTR; not OS permission; not equated to tool annotations alone | this PR |
| A4 | `docs/architecture.md` pins `@modelcontextprotocol/server` 2.x + protocol era (2025-03-26 / 2026-07-28) | this PR |
...
Phase A backlog A1–A4 + A6 closed on this PR path. **A5** completions deferred (Phase B P1). Remaining Phase A work is **Phase A-thin** read quality (see [docs/ROADMAP.md](../ROADMAP.md)).
