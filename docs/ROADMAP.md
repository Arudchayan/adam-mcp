...
| Release tag / npm | Known | Git tag **v0.2.0** exists; **npm publish not done** (`npx` / registry install do not work yet). Path today: clone + `npm run setup`. Publish waits on [SECURITY.md](../SECURITY.md) |
